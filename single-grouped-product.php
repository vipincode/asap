...
<div class="sl_pr_details_main">
	<div class="sl_gpr_details">
		...
		<?php
			if(!empty($image_ids)) {
				$last_image_id = end($image_ids);
				$last_image_url = wp_get_attachment_image_url($last_image_id, 'full');
	 	?>
		<div style="background-image:url('<?php echo esc_url($last_image_url); ?>')" class="sl_pr_details_right sl_bg_white image_item slc-product-main-warpper">
